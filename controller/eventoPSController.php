...
class eventoPSController extends Controller {
    ...
    public function edit() {
        ...
        $data['tipo_evento'] = $this->Select(array('id' => 'idtipo_evento', 'name' => 'idtipo_evento', 'table' => 'tipo_evento where tipo_evento.idtipo_evento="3"', 'code' => $obj['idtipo_evento']));
//        $data['sub_eventos'] = $this->leer_sub_eventos($_GET['id'],  $obj['idtipo_evento'], $obj['UBIGEO']);
...
//,"UNIRSE"
    ...
    public function create() {
        $data = array();
        $view = new View();
        $data['tipo_evento'] = $this->Select(array('id' => 'idtipo_evento', 'name' => 'idtipo_evento', 'table' => 'tipo_evento where tipo_evento.idtipo_evento="3"'));
