...
<script>
    $(function () {
        ...
        ideven=$("#ideven").val();
         $.post('index.php','controller=evento_proyeccion_social&action=pdf_ps&idevento='+ideven,function(data){
        });
...
<div id="tabs">
    ...
    <a href="index.php?controller=evento_proyeccion_social" class="btn btn-primary active" role="button"><img alt="" src="images/arrow_left.png" />REGRESAR</a>
    <a style="color: #ffffff; " class="btn btn-primary btn-sm" href="evento.pdf" target="_blanc">OBTENER PDF</a>
